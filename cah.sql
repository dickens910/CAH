...
--
-- Client :  localhost
-- Généré le :  Mer 19 Avril 2017 à 00:04
...
--
-- Structure de la table `blackcards`
--

CREATE TABLE IF NOT EXISTS `blackcards` (
  `black` varchar(127) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Contenu de la table `blackcards`
--

INSERT INTO `blackcards` (`black`) VALUES
(NULL),
('. High five, bro.'),
...
('When I''m in prison, I''ll have '),
(' smuggled in.'),
('After Hurricane Katrina, Sean Penn brought '),
...
(' out of '),
('.'),
('In his new summer comedy, Rob Schneider is '),
...
('yves', 'yves', 1, 'gabriel@hotmail.com', 5),
('ali', 'ali', 4, NULL, 9),
('alis', 'alis', 5, 'alis', 3),
('seb', 'seb', 6, '', 0),
('alide', 'alide', 7, '', 0),
...
--
-- Structure de la table `whitecards`
--

CREATE TABLE IF NOT EXISTS `whitecards` (
  `white` varchar(112) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Contenu de la table `whitecards`
--

INSERT INTO `whitecards` (`white`) VALUES
('A Gypsy curse.'),
('A moment of silence.'),
('A sausage festival.'),
